...
export const MODULES: ModuleDef[] = [
  ...
  { id: "manufacturing", label: "Manufacturing", description: "BOMs, Production Orders", icon: "cog" },
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { label: "Inventory", key: "inventory", icon: "package", module: "inventory", items: [
    ...
    { to: "/manufacturing", label: "Manufacturing", icon: "cog", module: "manufacturing" },
...
export const SEARCH_COMMANDS: SearchCommand[] = [
  ...
  { id: "new-bom", label: "New BOM", category: "Create", icon: "cog", to: "/manufacturing", params: { tab: "boms", action: "new" }, module: "manufacturing" },
  { id: "new-production-order", label: "New Production Order", category: "Create", icon: "cog", to: "/manufacturing", params: { tab: "production", action: "new" }, module: "manufacturing" },

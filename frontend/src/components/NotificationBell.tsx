  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="relative rounded-lg p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-[#282832] dark:hover:text-[#cbd5e1] transition-colors"
        title="Notifications"
      >

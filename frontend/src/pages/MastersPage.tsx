...
export default function MastersPage() {
  ...
  return (
    <div>
      <div>
        <h1 className="text-lg font-bold text-slate-900 dark:text-[#f1f5f9] mb-1">Masters</h1>
        <p className="text-sm text-slate-500 dark:text-[#64748b] mb-6">{groups.length} groups · {ledgers.length} ledgers</p>
      </div>

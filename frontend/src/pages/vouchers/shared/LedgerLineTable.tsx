    ...
    <div>
      <div className="overflow-x-auto rounded border border-slate-200">
        <table className="w-full text-sm">
          ...
          <tfoot>
            <tr className="border-t-2 border-slate-300 bg-slate-50 text-sm font-semibold">
      ...
      <div className="mt-1.5 flex items-center gap-3">
        <button
          type="button"
          onClick={addLine}
          className="rounded border border-dashed border-slate-300 px-2.5 py-0.5 text-[11px] font-medium text-slate-500 hover:border-brand-400 hover:text-brand-600 hover:bg-brand-50"
        >
          + Add Line
        </button>
